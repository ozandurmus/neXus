...
Implemented 2026-09-25 (V84): confirm (sysinfo), inventory (network part of the XML export, element names logged first), backup (four exports of Backbox trail 34411066, .cfg protected with the device's export passphrase; a missing export is partial). Awaiting the first device.
