...
2026-09-13 realignment: closed as superseded; the R2 production-server validation is the real-environment half of ui2_ssh_strict_host_key_trust_in_production.
