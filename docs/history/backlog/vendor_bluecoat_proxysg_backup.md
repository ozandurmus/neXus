...
2026-09-22 PO: the device is ProxySG (appliance or virtual), not SSL Visibility; contract written from the SGOS CLI reference (show configuration / expanded), MEASURE FIRST on one appliance.
