...
describe("the UI 2.0 shell navigation", () => {
  ...
  it("expands to the M3Components drawer and back", () => {
    ...
    expect(within(collapsedRail).getByAltText("neXus")).toBeInTheDocument();
  });
