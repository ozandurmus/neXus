...
The next architecture movement is the PO-approved diagnostic command screen and shared CLI
(`docs/design/FMG_SINGLE_COMMAND_DIAGNOSTIC_CLI.md`, DRAFT); no new device command is authorized by that draft.
