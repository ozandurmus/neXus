...
Build: ui2_d1_restore_c7_c2_amendments · Track: PCP.x · Generated: 2026-09-12T13:09:38Z
...
- P1/planned agent_frozen_contract_audit — Audit the contracts the agent froze or amended on its own hand (PO_DECISION_RECO (target: PO_DECISION_RECORD_2026_09_12 section 6)
...
- P1/planned cp_cphaprob_command_gate — Network-device command gate for cphaprob stat, cphaprob -a if, cphaprob tablesta (target: AI_DEVELOPMENT_PROTOCOL command gate)
...
- P1/planned failover_readiness_check_contract — Failover readiness check contract carrying the PO's four semantics (reciprocal p (target: PO_DECISION_RECORD_2026_09_12 section 3)
...
- P1/planned ui2_device_add_discovery_and_manual — Device add: discovery (Panorama/MDS) and manual, with operator multi-select impo (target: PO_DECISION_RECORD_2026_09_12 section 4)
...
- P1/planned ui2_local_auth_successor_contract — Local-authentication successor contract, required before any local login path (target: UI2_0_C3 Correction C-2)
...
- po_cp_backup_async_semantics — CP R81.20 backup is asynchronous, contradicting the blocking-backup assumption the contracts were wr
- po_ldap_tls_trust_policy — LDAP TLS trust: CA bundle format and whether the product pins the directory certificate.
## Recent builds
